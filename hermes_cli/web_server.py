...
from hermes_cli.web_routers import (  # noqa: E402
    ...
    jarvis_jev as _jarvis_jev_routes,
    public_apis as _public_apis_routes,
)
...
app.include_router(_jarvis_jev_routes.router)
app.include_router(_public_apis_routes.router)
