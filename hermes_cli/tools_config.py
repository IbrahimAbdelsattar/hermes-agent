...
TOOL_CATEGORIES = {
    "tts": {
        ...
        "providers": [
            ...
            _row("MiniMax TTS", "paid", "High-quality multilingual speech and voice cloning",
                 [_key("MINIMAX_API_KEY", "MiniMax API key", "https://platform.minimax.io/")], tts_provider="minimax"),
            ...
            _row("NeuTTS", "local · free", "Local neural TTS; run hermes setup tts for installation",
                 tts_provider="neutts"),
